...
<!-- middel content section --> 
             <div class="row"> 
				<div class="panel-body">
					<form action="<?php echo base_url('article/addArticle');?>" role="form" id="form1" method="post" enctype="multipart/form-data">
						<div class="row">
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Category <span class="symbol required" aria-required="true"></span>
									</label>
									<select class="form-control" name="category_id" id="category_id" >
                                    <?php echo select_grid('article_category','title'); ?>
                                    </select>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Title <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" placeholder="Article title" class="form-control" id="article_title" name="article_title">
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Description <span class="symbol required" aria-required="true"></span>
									</label>
									<!--<input type="text" placeholder="Insert your role" class="form-control" id="cat_description" name="cat_description">-->
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Meta Title <span class="symbol required" aria-required="true"></span>
									</label>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Meta keywords <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" placeholder="Meta keywords" class="form-control" id="meta_keywords" name="meta_keywords">
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Meta Description <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" placeholder="Meta Description" class="form-control" id="meta_description" name="meta_description">
								</div>
							</div>
                             ...
                             <div class="col-md-5">
								<div class="form-group">
									<label class="control-label">
										Article Image<span class="symbol required" aria-required="true"></span>
									</label>
                             ...
                             <div class="col-md-2">
								<div class="form-group">
									<label class="control-label">
										Select Audio / Video Type <span class="symbol required" aria-required="true"></span>
									</label>
                             ...
                             <div class="col-md-5">
								<div class="form-group">
									<label class="control-label">
										Upload Article Audio / Video <span class="symbol required" aria-required="true"></span>
									</label>
                       ...
                       <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input type="file" class="form-control" id="banner_img" name="banner_img" style="height: 100%;" accept="image/*">
                             ...
                             <div class="col-md-4">
								<div class="form-group">
									<label class="control-label">
										isFeatures <span class="symbol required" aria-required="true"></span>
									</label>
                            ...
                            <div class="col-md-4">
								<div class="form-group">
									<label class="control-label">
										Published Date <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" placeholder="Published Date" class="form-control" id="published_date" name="published_date">
								</div>
							</div>
						...
						<p></p>
							...
							<div class="col-md-2">
							  <a href="<?php echo base_url('article');?>" class="btn btn-light-grey btn-block">								
