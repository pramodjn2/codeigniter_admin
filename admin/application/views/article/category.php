        ...
        <div id="titr-content" class="col-md-12">
          <h2><?php echo ucwords($title); ?> </h2>
           <h5>&nbsp;</h5>
             ...
             <div class="actions">
           <a href="<?php echo base_url('article/addCategory');?>" class="btn btn-success  has-ripple">
            Add new category
           </a>
          </div>
        </div>
                    ...
                    <tbody>
					 ...
					 ?>
                      <tr>
                        ...
                        <td><div class="action-buttons"> <a class="blue" href="<?php echo base_url('article/editCategory/' .$id) ?>"> Edit</a> 
                        </div></td>
                      </tr>
                      <?php } 
										       } ?>
