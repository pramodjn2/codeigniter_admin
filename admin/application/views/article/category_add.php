...
<!-- middel content section --> 
             <div class="row"> 
				<div class="panel-body">
					<form action="<?php echo base_url('article/addCategory');?>" role="form" id="form1" method="post">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" placeholder="category title" class="form-control" id="cat_title" name="cat_title">
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Insert category description" class="form-control" id="cat_description" name="cat_description">
