    ...
    <div id="content">
      <div id="sortable-panel" class="">
        <div id="titr-content" class="col-md-12">
          ...
          <h5>&nbsp;</h5>
          <div class="actions"> <a href="<?php echo base_url('websetting/addTemplate');?>" class="btn btn-success  has-ripple"> <?php echo ADD_NEW; ?> </a> </div>
        </div>
                    ...
                    <tbody>
					 ...
					 ?>
                      <tr>
                        ...
                        <td><div class="action-buttons"><a href="<?php echo base_url('websetting/editTemplate/'.$id);?>" class="blue"> Edit</a></div></td>
                      </tr>
                      <?php } 
										       } ?>
                    </tbody>
