        ...
        <div class="col-md-12">
          <div  class="panel panel-default">
            ...
            <div class="panel-body"> 
              ...
              <div class="row">
                <div class="panel-body">
                  <form action="<?php echo base_url('websetting/addTemplate/');?>" role="form" id="form1" novalidate method="post">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label"> Template Name <span class="symbol required" aria-required="true"></span> </label>
                          <input type="text" value="" class="form-control" id="name" name="name">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label"> Email Subject <span class="symbol required" aria-required="true"></span> </label>
                          <input type="text" value="" class="form-control" id="subject" name="subject">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label"> Email Message <span class="symbol required" aria-required="true"></span> </label>
