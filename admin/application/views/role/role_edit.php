...
<!-- middel content section --> 
             <div class="row"> 
				<div class="panel-body">
<?php if(!empty($result)){?>
					<form action="<?php echo base_url('User/editRole/'.$id);?>" role="form" id="form1" novalidate method="post">
						<div class="row">
							
							<div class="col-md-12">
								<div class="form-group">
									<input type="hidden" value="<?php echo $result[0]['id'];?>" id="roleId" name="roleId">
									<label class="control-label">
										Role <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" value="<?php echo $result[0]['role_name'];?>" class="form-control" id="role" name="role">
								</div>
							</div>
						</div>
						<div class="row">
