						...
						<div class="row">
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" value="" class="form-control" id="setting_name" name="setting_name">
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" value="" class="form-control" id="setting_value" name="setting_value">
								</div>
							</div>
