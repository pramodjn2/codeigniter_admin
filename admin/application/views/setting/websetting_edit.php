...
<!-- middel content section --> 
             <div class="row"> 
				<div class="panel-body">
<?php if(!empty($result)){?>
					<form action="<?php echo base_url('websetting/editWebsetting/'.$id);?>" role="form" id="form1" novalidate method="post">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="hidden" value="<?php echo $result[0]['id'];?>" id="setting_id" name="setting_id">
									<label class="control-label">
										Key <span class="symbol required" aria-required="true"></span>
									</label>
									<input disabled type="text" value="<?php echo $result[0]['setting_name'];?>" class="form-control" id="setting_name" name="setting_name">
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										Value <span class="symbol required" aria-required="true"></span>
									</label>
									<input type="text" value="<?php echo $result[0]['setting_value'];?>" class="form-control" id="setting_value" name="setting_value">
								</div>
							</div>
						...
						<p></p>
							...
							<div class="col-md-2">
							  <a href="<?php echo base_url('websetting');?>" class="btn btn-light-grey btn-block">								
