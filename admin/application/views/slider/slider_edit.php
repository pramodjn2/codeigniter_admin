...
<!-- middel content section --> 
        ...
        <?php 
        if(!empty($result)){?>
					<form action="<?php echo base_url('staticPages/editSlider/'.$id); ?>" role="form" id="form1" novalidate method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-12">
                ...
                <div class="col-md-3">
								<div class="form-group">
									<label class="control-label">
										Text Position <span class="symbol required" aria-required="true"></span>
									</label>
                      ...
                      <option <?php echo $sel; ?>  value="<?php echo $key; ?>"><?php echo ucfirst($val); ?></option>
							...
							<div class="col-md-9">
								<div class="form-group">
									...
									<input type="text" placeholder="Insert title" class="form-control" id="title" name="title" value="<?php echo $result[0]['title']; ?>">
								</div>
							</div>
              ...
              <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Insert Description" class="form-control" id="description" name="description" value="<?php echo $result[0]['description']; ?>">
								</div>
							</div>
                            ...
                            <div class="col-md-6">
								<div class="form-group">
									<label class="control-label">
										Image Upload <span class="symbol required" aria-required="true"></span>
									</label>
                            ...
                            <div class="col-md-6">
								<div class="form-group">
                                <?php $img = image_check($result[0]['img_name'],SLIDER);?>
									<img src="<?php echo $img; ?>" alt="<?php echo $result[0]['img_name']; ?>" style="height: 150px; width: 300px;" >
                             	</div>
							</div>
						...
						<p></p>
							...
							<div class="col-md-2">
							  <a href="<?php echo base_url('staticPages/slider');?>" class="btn btn-light-grey btn-block">								
