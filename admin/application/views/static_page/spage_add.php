        ...
        <div class="col-md-12">
          <div  class="panel panel-default">
            ...
            <div class="panel-body"> 
              ...
              <div class="row">
                <div class="panel-body">
                  <form action="<?php echo base_url('staticPages/addspage');?>" role="form" id="form1" novalidate method="post" enctype="multipart/form-data">
                    <div class="row">
                     ...
                     <!--<div class="col-md-12">
								<div class="form-group">
                                    ...
                                    <?php echo select_grid('manage_static_pages_category','cat_title'); ?>
                                    </select>
								</div>
							</div>-->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2"> <a href="<?php echo base_url('websetting/template');?>" class="btn btn-light-grey btn-block"> <i class="fa fa-arrow-circle-left"></i> <?php echo BACK; ?>  </a> </div>
                      <div class="col-md-3">
