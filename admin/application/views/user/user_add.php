...
<!-- middel content section --> 
             <div class="row"> 
				<div class="panel-body">
					<form action="<?php echo base_url('user/addUser');  ?>" role="form" id="form1" novalidate method="post">
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="form-group">
                                    ...
                                    <?php echo select_grid('user_role','role_name'); ?>
                                    </select>
								</div>
							</div>
                            ...
                            <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Insert your frist name" class="form-control" id="first_name" name="first_name" value="<?php if($first_name){ echo $first_name; } ?>">
								</div>
							</div>
                          ...
                          <div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Insert your Last name" class="form-control" id="last_name" name="last_name">
								</div>
							</div>
